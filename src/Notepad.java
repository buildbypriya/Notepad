...
final String aboutText=
	"<html><big>Issac Javapad</big><hr><hr>"
	+"<p align=right>For Educational Purpose!"
	+"<hr><p align=left>Used jdk1.8 to compile the source code.<br><br>"
	+"<strong>Thanx 4 using Java Based Text Editor</strong><br>"
	+"Ur Comments as well as bug reports r very welcome at<p align=center>"
	+"<hr><em><big>issac@issacitlabs.com</big></em><hr><html>";
}